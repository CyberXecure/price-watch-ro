param(
    [string]$ZipName = "price-watch-ro-release-clean.zip"
)

$ErrorActionPreference = "Stop"

$ProjectRoot = Split-Path -Parent $PSScriptRoot
$TempDir = Join-Path $env:TEMP "price-watch-ro-release-package"
$ZipPath = Join-Path $ProjectRoot $ZipName

Write-Host "=== PACKAGE release clean ZIP ==="
...
Write-Host ""
Write-Host "ZIP release curat creat:"
Write-Host $ZipPath
